...
# Load Data
data <- read.csv("/Users/ritikajain/Desktop/Merged_Flow_Data 2.csv")
colnames(data)[7] <- "Sex"
...
volcano_plot <- function(data, cell_list, short_labels, conditions, condition_titles, dir){
  ...
  for(i in 1:length(conditions)){
    ...
    ggsave(paste0(title, "_volcano.pdf"), p, device = "pdf", width = 12, height = 10)
...
volcano_plot(
  ...
  dir             = "/Users/ritikajain/Desktop/V_VolcanoPlots"
)